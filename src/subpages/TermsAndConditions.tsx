			...
			<section className='terms'>
				<div className='terms__container dark-blue-gradient'>
					...
					<div className='terms__box'>
						...
						<p className='terms__text'>
							Dane użytkownika (takie jak adres e-mail, czy numer telefonu) są gromadzone wyłącznie podczas korzystania
							z formularza kontaktowego i/lub składania zamówienia.
						</p>
					</div>
					<div className='terms__box'>
